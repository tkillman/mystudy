...
public class Shoot1 extends JFrame implements Runnable, KeyListener {
 ...
 private ArrayList msList2 = null;
 ...
 public void draw() {
  ...
  for(int i = 0; i < msList1.size(); i++) {
	   ...
	   gs.setColor(Color.blue);
	   gs.drawOval(m1.x, m1.y, m1.w, m1.h);
	   if(m1.y < 0) msList1.remove(i);
	   m1.moveMs();
	  }
